                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo e(route('student.destroy', $branch->id)); ?>" method="Post">
                                        ...
                                        <p>Are you sure you want to delete this (<?php echo e($branch->branch); ?>) Branch ? </p>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('student.destroy', $student_category->cat_id)); ?>" method="Post">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('Delete'); ?>
                                    <p>Are you sure you want to delete this (<?php echo e($student_category->category); ?>) Student Category ? </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Laravel-Library-Management-system-main\resources\views/panel/addsettings.blade.php ENDPATH**/ ?>