			...
			<div class="module module-login span4 offset4">
				<form class="form-vertical" action="<?php echo e(URL::route('account-create-post')); ?>" method="POST">
					...
					<div class="module-foot">
						...
						<a href="<?php echo e(URL::route('account-sign-in')); ?>">Already A User?</a>
					</div>
				</form>
			</div>
		</div>
...
<?php echo $__env->make('account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Laravel-Library-Management-system-main\resources\views/account/create.blade.php ENDPATH**/ ?>