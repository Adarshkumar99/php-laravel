	...
	<div class="container">
		<div class="row">
			<div class="module module-login span4 offset1">
				<form class="form-vertical" action="<?php echo e(URL::route('account-sign-in-post')); ?>" method="POST">
					...
					<div class="module-foot">
						...
						<a href="<?php echo e(URL::route('account-create')); ?>">New librarian? Sign Up</a>
					</div>
				</form>
			</div>
			<div class="module module-login span4 offset2">
				...
				<div class="module-body">
                    <p><a href="<?php echo e(URL::route('student-registration')); ?>"><strong>Student Registration Form</strong></a></p>
                    <p><a href="<?php echo e(URL::route('search-book')); ?>"><strong>Search Book</strong></a></p>
				</div>
			</div>
        </div>
	</div>
...
<?php echo $__env->make('account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Laravel-Library-Management-system-main\resources\views/account/signin.blade.php ENDPATH**/ ?>